...
d1 = d1[['id', 'exposure_unit', 'damage_cost_unit', 'hazard', 'rcp', 'epoch',
       'EAD_undefended_mean', 'EAD_undefended_min', 'EAD_undefended_max',
       'EAD_undefended_median', 'EAD_undefended_q5', 'EAD_undefended_q95',
       'subtype','parish']]

d2 = d2.merge(edges,on='id',how='left')
d2 = d2[['id', 'exposure_unit', 'damage_cost_unit', 'hazard', 'rcp', 'epoch',
       'EAD_undefended_mean', 'EAD_undefended_min', 'EAD_undefended_max',
       'EAD_undefended_median', 'EAD_undefended_q5', 'EAD_undefended_q95',
       'asset_type','parish']]
